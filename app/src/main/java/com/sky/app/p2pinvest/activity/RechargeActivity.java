...
import com.sky.app.p2pinvest.util.pay.PayKeys;
import com.sky.app.p2pinvest.util.pay.PayResult;
import com.sky.app.p2pinvest.util.pay.SignUtils;
                ...
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            UIUtils.toast("支付结果确认中", false);
                        } else {
                            // 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
                            UIUtils.toast("支付失败", false);
                        }
                    }
                    break;
                }
...
//        UIUtils.toast("充值", false);
        // 订单
        String orderInfo = getOrderInfo("iphone X 256GB", "史上最高配置iphone手机", "0.01");
        ...
        // 必须异步调用
        MyApplication.singleThreadPool.execute(payRunnable);
    }
